		...
		function renderPreviewBody(data, translate) {
			...
			if (data.kind === "office") {
				return react.createElement(
					react.Fragment,
					null,
					react.createElement("p", { className: "fp_note" }, translate("panel.office")),
					data.url !== void 0 && react.createElement(
						"div",
						{ style: { marginTop: "12px" } },
						react.createElement(
							"a",
							{ className: "fp_chipName", href: data.url, download: data.name, style: { fontSize: "13px" } },
							translate("panel.download", { name: data.name })
						)
					)
				);
			}
