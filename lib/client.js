...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const css = [
			...
			".fp_panel,.fp_header,.fp_footer{background:var(--dsw-static-neutral-bluish-00)}",
			"body[data-ds-dark-theme] .fp_panel,body[data-ds-dark-theme] .fp_header,body[data-ds-dark-theme] .fp_footer{background:var(--dsw-static-neutral-bluish-950)}",
			".fp_body{background:transparent}",
			":root{--dsw-specific-sidebar-fill:var(--dsw-static-neutral-bluish-50) !important}",
			"body[data-ds-dark-theme]{--dsw-specific-sidebar-fill:var(--dsw-static-neutral-bluish-900) !important}"
		].join("");
		...
		const en = {
			...
			"panel.officeExtracted": "Extracted text preview from {format} (layout not included)",
			"kind.text": "text",
			"kind.image": "image",
			"kind.pdf": "PDF",
			"kind.office": "Office",
